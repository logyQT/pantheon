...
**Pantheon** is an advanced Quality of Life (QOL) modification created for Hypixel Skyblock players. The mod runs on the **Fabric (Minecraft 1.21.1)** engine and focuses on providing automation tools and an extensive social game system.
